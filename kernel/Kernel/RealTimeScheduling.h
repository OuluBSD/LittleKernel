#ifndef _Kernel_RealTimeScheduling_h_
#define _Kernel_RealTimeScheduling_h_
...
extern RealTimeScheduler* g_real_time_scheduler;

// Initialize real-time scheduling system
bool InitializeRealTimeScheduling();
...
#endif // _Kernel_RealTimeScheduling_h_